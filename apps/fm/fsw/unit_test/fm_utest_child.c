/************************************************************************
**
** $Id: fm_utest_child.c 1.4.1.1 2012/05/02 15:00:51EDT acudmore Exp  $
**
** Notes:
**
...
** Revision 1.4.1.1 2012/05/02 15:00:51EDT acudmore 
** FM Delete All unit test update
...
void Test_child(void)
{
    ...
    */
    ...
    FM_ChildTask();
    TestCount++;
    if (FM_GlobalData.ChildSemaphore != 0)
    {
    ...
    */
    ...
    FM_ChildProcess();
    TestCount++;
    if ((FM_GlobalData.ChildCmdErrCounter == 0) || (FM_GlobalData.ChildSemaphore == 1))
    {
    ...
    */
    ...
    /* (1) Invalid source filename */
    FM_GlobalData.ChildCmdErrCounter = 0;
    FM_GlobalData.ChildSemaphore  = 0;
    FM_GlobalData.ChildQueueCount = 0;
    FM_GlobalData.ChildReadIndex  = 0;
    FM_GlobalData.ChildWriteIndex = 0;
    ...
    */
    ...
    /* Create some directories and files first */
    OS_mkdir("/ram/DeleteAllSubDir",0);
    OS_mkdir("/ram/DeleteAllSubDir/SubDir1",0);
    OS_mkdir("/ram/DeleteAllSubDir/SubDir2",0);

    OS_mkdir("/ram/DeleteAllOSRM",0);
    CreateTestFile("/ram/DeleteAllOSRM/test.dat", 16, FALSE);
    OS_mkdir("/ram/DeleteAllOpenFile",0);
    CreateTestFile("/ram/DeleteAllOpenFile/test.dat", 16, FALSE);
    ...
    CmdArgs = &FM_GlobalData.ChildQueue[0];
    CFE_PSP_MemSet(CmdArgs, 0, sizeof(FM_ChildQueueEntry_t));
    strcpy(CmdArgs->Source1, "/ram/DeleteAllSubDir");
    FM_ChildDeleteAllCmd(CmdArgs);
    TestCount++;
    ...
    /* (3) Skip an open file in the directory */
    /*    First, open a file that the command can then skip  */
    tempFd = open("ram2/DeleteAllOpenFile/test.dat",O_RDONLY); 
    FM_GlobalData.ChildCmdErrCounter = 0;
    FM_GlobalData.ChildSemaphore  = 0;
    FM_GlobalData.ChildQueueCount = 0;
    FM_GlobalData.ChildReadIndex  = 0;
    ...
    CmdArgs = &FM_GlobalData.ChildQueue[0];
    CFE_PSP_MemSet(CmdArgs, 0, sizeof(FM_ChildQueueEntry_t));
    strcpy(CmdArgs->Source1, "/ram/DeleteAllOpenFile");
    FM_ChildDeleteAllCmd(CmdArgs);
    close(tempFd);
    TestCount++;
    if (FM_GlobalData.ChildCmdWarnCounter == 0)
    ...
    CmdArgs = &FM_GlobalData.ChildQueue[0];
    CFE_PSP_MemSet(CmdArgs, 0, sizeof(FM_ChildQueueEntry_t));
    strcpy(CmdArgs->Source1, "/ram/DeleteAllOSRM");
    ...
    */
    ...
    CFE_PSP_MemSet(CmdArgs, 0, sizeof(FM_ChildQueueEntry_t));
    strcpy(CmdArgs->Source1, "/ram/doesnotexist");
    strcpy(CmdArgs->Source2, "/ram/closed5.bin");
    ...
    CmdArgs = &FM_GlobalData.ChildQueue[0];
    CFE_PSP_MemSet(CmdArgs, 0, sizeof(FM_ChildQueueEntry_t));
    strcpy(CmdArgs->Source1, "/ram/closed5.bin");
    ...
    */
    ...
    CmdArgs = &FM_GlobalData.ChildQueue[0];
    CFE_PSP_MemSet(CmdArgs, 0, sizeof(FM_ChildQueueEntry_t));
    strcpy(CmdArgs->Source1, "/ram/xxx.bin");
    CmdArgs->FileInfoCRC = CFE_ES_CRC_16;
    CmdArgs->FileInfoState = FM_NAME_IS_FILE_CLOSED;
    ...
    */
    ...
    CmdArgs = &FM_GlobalData.ChildQueue[0];
    CFE_PSP_MemSet(CmdArgs, 0, sizeof(FM_ChildQueueEntry_t));
    strcpy(CmdArgs->Source1, "/ramxyz");
    strcpy(CmdArgs->Source2, "/ramxyz/");
    ...
    */
    ...
    FM_GlobalData.ChildCmdErrCounter = 0;
    iResult = 0;
    bResult = FM_ChildDirListFileInit(&iResult, "/ram", "/ramxxx/outfile.bin");
    TestCount++;
    ...
    */
    ...
    uArg1 = 0;
    uArg2 = 0;
    iResult = FM_ChildSizeAndTime("/ram/closed5.bin", &uArg1, &uArg2);
    TestCount++;
    if ((uArg1 == 0) || (uArg2 == 0))
    {
