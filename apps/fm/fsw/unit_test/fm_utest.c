/************************************************************************
** File:
**   $Id: fm_utest.c 1.6 2010/03/08 15:49:14EST lwalling Exp  $
**
** Purpose:
...
int main(void)
{
    ...
    */
    ...
    CreateTestFile("/ram/closed2.bin", 16, FALSE);
    CreateTestFile("/ram/closed3.bin", 16, FALSE);
    CreateTestFile("/ram/closed4.bin", 16, FALSE);
    CreateTestFile("/ram/closed5.bin", 16, FALSE);

    CreateTestFile("/ram/open1.bin", 16, TRUE);

    CreateTestFile("/ram/sub/sub1.bin", 16, FALSE);
    CreateTestFile("/ram/sub/sub2.bin", 16, FALSE);
    CreateTestFile("/ram/sub/sub3.bin", 16, FALSE);
    CreateTestFile("/ram/sub/sub4.bin", 16, FALSE);
    ...
    */
    OS_remove("/ram/sub/open1.bin");
    OS_remove("/ram/sub/closed4.bin");
    OS_remove("/ram/sub/closed5.bin");
...
void PrintHKPacket (uint8 source, void *packet)
{
    ...
    UTF_put_text("CommandWarnCounter = %d\n", HousekeepingPkt->CommandWarnCounter);
