/*
** $Id: fm_child.c 1.17.1.2 2012/04/26 16:53:49EDT acudmore Exp  $
**
...
**
** $Log: fm_child.c  $
** Revision 1.17.1.2 2012/04/26 16:53:49EDT acudmore 
** Updated FM Child DeleteAll command
** Revision 1.17.1.1 2012/04/26 16:38:16EDT acudmore 
...
void FM_ChildTask(void)
{
    ...
    */
    ...
    else
    {
        ...
        Result = OS_BinSemCreate(&FM_GlobalData.ChildSemaphore,
                                    FM_CHILD_SEM_NAME, 0, 0);
        if (Result != CFE_SUCCESS)
        {
            CFE_EVS_SendEvent(FM_CHILD_INIT_ERR_EID, CFE_EVS_ERROR,
    ...
    CFE_ES_DeleteChildTask(FM_GlobalData.ChildTaskID);
...
void FM_ChildLoop(void)
{
    ...
    while (Result == CFE_SUCCESS)
    {
        ...
        Result = OS_BinSemTake(FM_GlobalData.ChildSemaphore);
...
void FM_ChildProcess(void)
{
    ...
    /* Update the number of entries in the handshake queue */
...
void FM_ChildCopyCmd(FM_ChildQueueEntry_t *CmdArgs)
{
    ...
    else
    {
        ...
        CFE_EVS_SendEvent(FM_COPY_CMD_EID, CFE_EVS_INFORMATION,
...
void FM_ChildMoveCmd(FM_ChildQueueEntry_t *CmdArgs)
{
    ...
    else
    {
        ...
        /* Send command completion event (info) */
        CFE_EVS_SendEvent(FM_MOVE_CMD_EID, CFE_EVS_INFORMATION,
           "%s command: src = %s, tgt = %s",
            CmdText, CmdArgs->Source1, CmdArgs->Target);
    }
...
void FM_ChildRenameCmd(FM_ChildQueueEntry_t *CmdArgs)
{
    ...
    else
    {
        ...
        /* Send command completion event (info) */
        CFE_EVS_SendEvent(FM_RENAME_CMD_EID, CFE_EVS_INFORMATION,
           "%s command: src = %s, tgt = %s",
            CmdText, CmdArgs->Source1, CmdArgs->Target);
    }
...
void FM_ChildDeleteCmd(FM_ChildQueueEntry_t *CmdArgs)
{
    ...
    else
    {
        ...
        {
            /* Send command completion event (info) */
            CFE_EVS_SendEvent(FM_DELETE_CMD_EID, CFE_EVS_INFORMATION,
...
void FM_ChildDeleteAllCmd(FM_ChildQueueEntry_t *CmdArgs)
{
    ...
    */
    ...
    else
    {
        ...
        /* Send command completion event (info) */
        CFE_EVS_SendEvent(FM_DELETE_ALL_CMD_EID, CFE_EVS_INFORMATION,
...
void FM_ChildDecompressCmd(FM_ChildQueueEntry_t *CmdArgs)
{
    ...
    CFE_Status = -1; /* CFE_FS_Decompress(CmdArgs->Source1, CmdArgs->Target); */
    ...
    else
    {
        ...
        /* Send command completion event (info) */
        CFE_EVS_SendEvent(FM_DECOM_CMD_EID, CFE_EVS_INFORMATION,
           "%s command: src = %s, tgt = %s",
            CmdText, CmdArgs->Source1, CmdArgs->Target);
    }
...
void FM_ChildConcatCmd(FM_ChildQueueEntry_t *CmdArgs)
{
    ...
    if (ConcatResult == TRUE)
    {
        ...
        /* Send command completion event (info) */
        CFE_EVS_SendEvent(FM_CONCAT_CMD_EID, CFE_EVS_INFORMATION,
...
void FM_ChildCreateDirCmd(FM_ChildQueueEntry_t *CmdArgs)
{
    ...
    else
    {
        ...
        /* Send command completion event (info) */
        CFE_EVS_SendEvent(FM_CREATE_DIR_CMD_EID, CFE_EVS_INFORMATION,
...
void FM_ChildDeleteDirCmd(FM_ChildQueueEntry_t *CmdArgs)
{
    ...
    if (RemoveTheDir)
    {
        ...
        {
            /* Send command completion event (info) */
            CFE_EVS_SendEvent(FM_DELETE_DIR_CMD_EID, CFE_EVS_INFORMATION,
               "%s command: src = %s", CmdText, CmdArgs->Source1);
...
void FM_ChildDirListPktCmd(FM_ChildQueueEntry_t *CmdArgs)
{
    ...
    */
    ...
    else
    {
        ...
        /* Send command completion event (info) */
        CFE_EVS_SendEvent(FM_GET_DIR_PKT_CMD_EID, CFE_EVS_INFORMATION,
                             ...
                             char *Directory, char *DirWithSep, char *Filename)
{
    ...
    if (CommandResult == TRUE)
    {
        ...
        CFE_EVS_SendEvent(FM_GET_DIR_FILE_CMD_EID, CFE_EVS_INFORMATION,
