/*
** $Id: fm_msg.h 1.26 2011/07/04 13:57:22EDT lwalling Exp  $
**
...
typedef struct
{
    ...
    char    Target[OS_MAX_PATH_LEN_SHORT];  /**< \brief Target filename */
...
typedef struct
{
    ...
    uint8   CommandWarnCounter;             /**< \fmtlmmnemonic \FM_WarnCtr
                                                 \brief Application command warning counter */
...
typedef struct
{
    ...
    uint32  ChildSemaphore;                 /**< \brief Child task semaphore ID */
