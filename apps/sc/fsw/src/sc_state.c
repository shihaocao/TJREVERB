 /*************************************************************************
 ** File:
 **   $Id: sc_state.c 1.8 2010/09/28 10:33:10EDT lwalling Exp  $
 **
 ** Purpose: 
 ...
 **
 **   $Log: sc_state.c  $
 **   Revision 1.8 2010/09/28 10:33:10EDT lwalling 
                ...
                { /* The command length is zero indicating no more cmds */
                    ...
                    if ((RtsNum + 1) <= SC_LAST_RTS_WITH_EVENTS)
                    {
                        CFE_EVS_SendEvent (SC_RTS_COMPL_INF_EID,
                                           CFE_EVS_INFORMATION,
                                           "Relative Time Sequence %03d Execution Completed",
                                           RtsNum + 1);
                    }
                }
            }
    ...
    if (SC_OperData.AtsCtrlBlckAddr -> AtpState == SC_EXECUTING)
    {
        ...
        { /* the end is near... of the ATS buffer that is */
            ...
            CFE_EVS_SendEvent (SC_ATS_COMPL_INF_EID,
                               CFE_EVS_INFORMATION,
                               "Absolute Time Tagged Sequence %c Execution Completed",
                               (AtsIndex ? 'B' : 'A'));
