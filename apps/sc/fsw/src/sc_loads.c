 /*************************************************************************
 ** File:
 **   $Id: sc_loads.c 1.17 2011/11/16 13:59:10EST lwalling Exp  $
 **
 ** Purpose: 
 ...
 **
 **   $Log: sc_loads.c  $ 
 **   Revision 1.17 2011/11/16 13:59:10EST lwalling  
...
void SC_Insert (uint16 AtsIndex, int32 NewCmdIndex, int32 ListLength)
{
    ...
    SC_AbsTimeTag_t      NewCmdTime;    /* new command execution time */
