 /*************************************************************************
 ** File:
 **   $Id: sc_atsrq.c 1.12 2011/01/28 16:20:15EST lwalling Exp  $
 **
 ** Purpose: 
 ...
 **
 **   $Log: sc_atsrq.c  $
 **   Revision 1.12 2011/01/28 16:20:15EST lwalling 
                ...
                if (SC_OperData.AtsInfoTblAddr[AtsIndex].NumberOfCommands > 0)
                {
                    ...
                    {           
                        ...
                        CFE_EVS_SendEvent(SC_STARTATS_CMD_INF_EID,
                                          CFE_EVS_INFORMATION,
                                          "Absolute Time Tagged Sequence %c Execution Started",
                                          (AtsIndex ? 'B' : 'A'));
                    }
                    else
    ...
    {       
        ...
        if (Result == CFE_SUCCESS)
        {
            CFE_EVS_SendEvent(SC_STOPATS_CMD_INF_EID,
                              CFE_EVS_INFORMATION,
                              "Absolute Time Tagged Sequence %c stopped",
                              TempAtsChar);
        }
        else
        {
            ...
            if (SC_OperData.AtsInfoTblAddr[NewAtsNum].NumberOfCommands > 0)
            {
                ...
                if (SC_BeginAts (NewAtsNum, 1))
                {
                    ...
                    CFE_EVS_SendEvent(SC_ATS_SERVICE_SWTCH_INF_EID,
                                      CFE_EVS_INFORMATION ,
                                      "Absolute Time Tagged Sequence Switched from %c to %c",
