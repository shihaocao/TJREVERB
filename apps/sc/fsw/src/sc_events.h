 /*************************************************************************
 ** File:
 **   $Id: sc_events.h 1.6 2011/09/26 13:41:30EDT lwalling Exp  $
 **
 ** Purpose: 
 ...
 **
 **   $Log: sc_events.h  $ 
 **   Revision 1.6 2011/09/26 13:41:30EDT lwalling  
...
/** \brief <tt> 'Absolute Time Tagged Sequence \%c Execution Started' </tt>
**  \event <tt> 'Absolute Time Tagged Sequence \%c Execution Started' </tt>
**  
**  \par Type: INFORMATIONAL
**
**  \par Cause:
...
/** \brief <tt> 'Absolute Time Tagged Sequence \%c stopped' </tt>
**  \event <tt> 'Absolute Time Tagged Sequence \%c stopped' </tt>
**  
**  \par Type: INFORMATIONAL
**
**  \par Cause:
...
/** \brief <tt> 'Absolute Time Tagged Sequence Switched from \%c to \%c' </tt>
**  \event <tt> 'Absolute Time Tagged Sequence Switched from \%c to \%c' </tt>
**  
**  \par Type: INFORMATIONAL
**
**  \par Cause:
...
/** \brief <tt> 'Absolute Time Tagged Sequence \%c Aborted' </tt>
**  \event <tt> 'Absolute Time Tagged Sequence \%c Aborted' </tt>
**  
**  \par Type: ERROR
**
**  \par Cause:
...
/** \brief <tt> 'Relative Time Sequence \%03d Aborted' </tt>
**  \event <tt> 'Relative Time Sequence \%03d Aborted' </tt>
**  
**  \par Type: INFORMATIONAL
**
**  \par Cause:
...
/** \brief <tt> 'Relative Time Sequence \%03d Execution Completed' </tt>
**  \event <tt> 'Relative Time Sequence \%03d Execution Completed' </tt>
**  
**  \par Type: INFORMATIONAL
**
**  \par Cause:
...
/** \brief <tt> 'Absolute Time Tagged Sequence \%c Execution Completed' </tt>
**  \event <tt> 'Absolute Time Tagged Sequence \%c Execution Completed' </tt>
**  
**  \par Type: INFORMATIONAL
**
**  \par Cause:
...
/** \brief <tt> 'Unbundle RTS OK: \%s, Dest: \%s, RTS Num: \%d, RTS Size: \%d' </tt>
**  \event <tt> 'Unbundle RTS OK: \%s, Dest: \%s, RTS Num: \%d, RTS Size: \%d' </tt>
**  
**  \par Type: INFORMATION
**
**  \par Cause:
**  This event message is issued following the successful execution of
**  a #SC_UNBUNDLE_RTS_CC command, or startup RTS unbundle process 
**  
**  The event text includes the source RTS Bundle file name, RTS destination path,
**  and the Starting RTS Number of the unbundled RTSs.  
*/
#define SC_UNBUNDLE_RTS_INF_EID                           123

/** \brief <tt> 'Unbundle RTS Cmd Inv Param: \%s, Dest: \%s, RTS Num: \%d, RTS Size: \%d' </tt>
**  \event <tt> 'Unbundle RTS Cmd Inv Param: \%s, Dest: \%s, RTS Num: \%d, RTS Size: \%d' </tt>
**  
**  \par Type: ERROR 
**
**  \par Cause:
**  This event message is issued following an error with the  
**   #SC_UNBUNDLE_RTS_CC command. Specifically, one of the command parameters is invalid.
**  
**  The event text includes the source RTS Bundle file name, RTS destination path,
**  and the Starting RTS Number of the unbundled RTSs.  
*/
#define SC_UNBUNDLE_RTS_CMD_ERR_EID                             124


/** \brief <tt> 'Unbundle RTS Failed. Status = \%d' </tt>
**  \event <tt> 'Unbundle RTS Failed. Status = \%d' </tt>
**  
**  \par Type: ERROR 
**
**  \par Cause:
**  This event message is issued following an error with the  
**   #SC_UNBUNDLE_RTS_CC command, or the startup RTS unbundle process.
**  
**  The event text includes the status from the RTS Unbundle function.  
*/
#define SC_UNBUNDLE_RTS_ERR_EID                                 125
