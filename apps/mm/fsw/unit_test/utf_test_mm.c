/************************************************************************
** File:
**   $Id: utf_test_mm.c 1.12 2011/12/05 15:17:57GMT-05:00 jmdagost Exp  $
**
** Purpose: 
...
** 
**   $Log: utf_test_mm.c  $
**   Revision 1.12 2011/12/05 15:17:57GMT-05:00 jmdagost 
...
void PrintHKPacket (void)
{
   ...
   UTF_put_text("   Fill Pattern            = 0x%08X\n", MM_AppData.HkPacket.FillPattern);
