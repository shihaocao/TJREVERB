/************************************************************************
** File:
**   $Id: mm_app.c 1.13 2011/11/30 15:58:34GMT-05:00 jmdagost Exp  $
**
** Purpose: 
...
**
**   $Log: mm_app.c  $
**   Revision 1.13 2011/11/30 15:58:34GMT-05:00 jmdagost 
   ...
   */
   if (MM_VerifyCmdLength(msg, ExpectedLength))
   {
      ...
      */   
      ...
      MM_AppData.HkPacket.FillPattern    = MM_AppData.FillPattern;
