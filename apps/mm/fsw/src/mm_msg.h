/************************************************************************
** File:
**   $Id: mm_msg.h 1.7 2010/11/29 08:46:50GMT-05:00 jmdagost Exp  $
**
** Purpose: 
...
**
**   $Log: mm_msg.h  $
**   Revision 1.7 2010/11/29 08:46:50GMT-05:00 jmdagost 
...
typedef struct
{
    ...
    uint32            FillPattern;                     /**< \mmtlmmnemonic \MM_FILLPATTERN
                                                            \brief Fill pattern used if memory fill command was issued */    
