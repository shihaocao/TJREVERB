/*
** $Id: sch_def_schtbl4.c 1.1 2011/06/30 21:01:09EDT aschoeni Exp  $
**
...
#define SCH_GROUP_ACS         (0x000002)                        /* All ACS  Messages        */
...
#define SCH_GROUP_ACS_HK      (  (0x000040) | SCH_GROUP_ACS)    /* ACS HK Messages          */
